...
//   constructor(width = 1, height = 1, radius = 0.2, steps = 8) {
//     super();
...
//     // helper to add quarter circle corner
//     const addCorner = (cx, cy, start, end) => {
//       for (let i = 0; i <= steps; i++) {
...
//         if (last > 1) {
//           this.addFace(0, last - 1, last);
//         }
//       }
//     };

//     // 4 corners (TR, TL, BL, BR)
//     addCorner(w - radius, h - radius, Math.PI * 1.5, Math.PI * 2.0); // top-right
//     addCorner(-w + radius, h - radius, Math.PI, Math.PI * 1.5);      // top-left
//     addCorner(-w + radius, -h + radius, Math.PI * 0.5, Math.PI);     // bottom-left
//     addCorner(w - radius, -h + radius, 0.0, Math.PI * 0.5);          // bottom-right
...
class RoundedRectGeometry extends Geometry {
   ...
   * @param {number} steps - number of segments per corner
   */
  constructor(width = 1, height = 1, radius = 0.2, steps = 4) {
    super();
    ...
    // center vertex (like DiscGeometry)
    this.addVertex(0, 0, 0);
    this.lastVertex.uv[0] = 0.5;
    this.lastVertex.uv[1] = 0.5;
    ...
    // Top-right corner
    addCorner(w - radius, h - radius, 0, Math.PI / 2);
    // Top-left corner
    addCorner(-w + radius, h - radius, Math.PI / 2, Math.PI);
    // Bottom-left corner
    addCorner(-w + radius, -h + radius, Math.PI, 1.5 * Math.PI);
    // Bottom-right corner
    addCorner(w - radius, -h + radius, 1.5 * Math.PI, 2 * Math.PI);

    // Create faces (triangle fan)
    for (let i = 1; i < this.vertices.length - 1; i++) {
      this.addFace(0, i, i + 1);
    }
    this.addFace(0, this.vertices.length - 1, 1); // close the loop
  }
}
...
class InfiniteGridMenu {
  ...
  #init(onInit) {
    ...
    // this.discGeo = new RoundedRectGeometry(1.2, 1.2, 0.3, 12);
    // this.discGeo = new RoundedRectGeometry(1, 1, 0, 1);
    // this.discGeo = new RoundedRectGeometry(1.2, 1.2, 0.3, 12);
    this.discGeo = new RoundedRectGeometry(2.8, 1.8, 0.1, 12);
  ...
  return (
    <div className="relative w-full h-full bg-white">
      ...
      {activeItem && (
        ...
        `}
          >
                  <img className='w-[70px]  rounded-[20px]' src={activeItem.dp} />
        ...
        `}
          >
            <p className="select-none  relative text-[#000000] top-[2px] text-[26px]">
              &#x2197;
            </p>
          </div>
        </>
