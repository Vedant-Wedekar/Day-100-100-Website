...
<div className=""> <img className='w-100 rounded-[50px] h-50  top-0 left-0 object-cover z-[-1]  shadow-lg transform transition duration-300 ease-in-out hover:scale-105' src={W2}></img>
      <img className='w-100 rounded-[50px] h-50 mt-10  object-cover z-[-1] shadow-lg transform transition duration-300 ease-in-out hover:scale-105 ' src={W1}></img></div>
     

<CircularText
  text="LETS*EXPLORE*THE*WEBSITES*"
  onHover="speedUp"
  spinDuration={10}
...
<div className=""> <img className='w-100 rounded-[50px] h-50  top-0 left-0 object-cover z-[-1]  shadow-lg transform transition duration-300 ease-in-out hover:scale-105' src={W3}></img>
      <img className='w-100 rounded-[50px] h-50 mt-10  object-cover z-[-1]   shadow-lg transform transition duration-300 ease-in-out hover:scale-105' src={W4}></img></div>
</div>
