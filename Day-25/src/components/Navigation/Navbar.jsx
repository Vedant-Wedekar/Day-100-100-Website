...
import { ShiftingDropDown } from '../elements/ShiftingDropDown'
    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            <div className='lg:p-5 p-2 '>
                <div className='lg:w-45 w-24 -mt-10'>
            ...
            <div onClick={()=>{
                ...
                <div ref={navGreenRef} className='bg-[#afc5f7] transition-all absolute top-0 h-0 w-full'></div>
