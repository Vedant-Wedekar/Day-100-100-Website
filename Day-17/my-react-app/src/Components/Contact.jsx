...
const Contact = () => {
  return (
    <div><form class="flex flex-col items-center text-sm text-slate-800">
    <p class="text-xs bg-indigo-200 text-indigo-600 font-medium px-3 py-1 rounded-full">Contact Us</p> 
    <h1 class="text-4xl font-bold py-4 text-center">Let’s Get In Touch.</h1>
    <p class="max-md:text-sm text-gray-500 pb-10 text-center">
        Or just reach out manually to us at <a href="#" class="text-indigo-600 hover:underline">hello@prebuiltui.com</a>
    </p>
